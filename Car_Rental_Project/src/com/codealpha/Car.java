	...
	class CarRentalSystem {
	    ...
	    public void menu() {
	        ...
	        while (true) {
	            ...
	            System.out.println("3. Renter History");
	            ...
	            if (choice == 1) {
	                ...
	                System.out.println("Shahzad Ali C001 2 Days $600");
	 ...
	 class Main{
	    public static void main(String[] args) {
	        ...
	        Car car1 = new Car("C001", "Toyota", "Camry", 300); // Different base price per day for each car
